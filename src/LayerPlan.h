 ...
 */
    ...
    */
     ...
     */
      void addPolygon(ConstPolygonRef polygon, int startIdx, const GCodePathConfig &config, WallOverlapComputation *wall_overlap_computation = nullptr, coord_t wall_0_wipe_dist = 0, bool spiralize = false, const Ratio &flow_ratio = 1.0_r, bool always_retract = false, bool close = true);
     ...
     */
      ...
      bool writePathWithFiberCut(GCodeExport &gcode,
