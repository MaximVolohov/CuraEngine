...
namespace cura
{
    ...
    template <>
    FMatrix3x3 Settings::get<FMatrix3x3>(const std::string &key) const
    {
    ...
    template <>
    EWallsToReinforce Settings::get<EWallsToReinforce>(const std::string &key) const
    {
        const std::string &value = get<std::string>(key);
        if (value == "all")
        {
            return EWallsToReinforce::ALL;
        }
        else if (value == "inner")
        {
            return EWallsToReinforce::INNER;
        }
        else if (value == "outer")
        {
            return EWallsToReinforce::OUTER;
        }
        else
        {
            return EWallsToReinforce::ALL;
    ...
    EReinforcementType Settings::get<EReinforcementType>(const std::string &key) const
    {
        ...
        if (value == "concentric")
        {
            return EReinforcementType::CONCENTRIC;
        }
        else if (value == "isotropic")
        {
            return EReinforcementType::ISOTROPIC;
        }
        else
        {
            return EReinforcementType::CONCENTRIC;
