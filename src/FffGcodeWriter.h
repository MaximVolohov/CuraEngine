 ...
 */
    ...
    */
     ...
     */
      ...
      bool processFiberInfill(const SliceDataStorage &storage, LayerPlan &gcodeLayer, const SliceMeshStorage &mesh, const size_t extruder_nr, const PathConfigStorage::MeshPathConfigs &mesh_config, const SliceLayerPart &part) const;
