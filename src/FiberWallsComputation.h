...
#ifndef FIBER_WALLS_COMPUTATION_H
#define FIBER_WALLS_COMPUTATION_H
 ...
 */
     ...
     */
        FiberWallsComputation(const Settings &settings, const LayerIndex layer_nr);
...
#endif //FIBER_WALLS_COMPUTATION_H
