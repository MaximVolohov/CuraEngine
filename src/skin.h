 ...
 */
   ...
   public:
     ...
     */
      void generateSkinsAndInfill(bool use_skin);
   ...
   protected:
     ...
     */
      void generateSkinAndInfillAreas(bool use_skin);
     ...
     */
      void generateSkinAndInfillAreas(SliceLayerPart &part, bool use_skin);
   ...
   protected:
      ...
      const size_t fiber_wall_line_count;      //!< The number of walls, i.e. the number of the wall from which to offset.
      ...
      const coord_t fiber_wall_line_width;     //!< The line width of the inner most wall
