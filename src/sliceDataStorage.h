 ...
 */
   ...
   public:
      ...
      std::vector<Polygons> fiber_insets;
 ...
 */
   ...
   public:
      ...
      std::vector<AngleDegrees> fiber_infill_angles;      //!< a list of angle values which is cycled through to determine the infill angle of each layer
